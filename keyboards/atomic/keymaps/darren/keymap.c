 ...
 * |--------------------------------------------------------------------------------------------------------------------------------------|
 * |   LCTRL   |    WIN   |    ALT   |   LOWER  |       SPACE     |      BACKSP     |  RAISE |   F2   |CTRL+BKS|  LEFT  |  DOWN  | RIGHT  |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
 ...
 [_QW] = { /* QWERTY */
  ...
  { TD(CAPS_DTAP), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,  KC_ENT,  KC_HOME  },
  { KC_LSFT,       KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_RSFT, KC_UP,   KC_END   },
  { KC_LCTL,       KC_LGUI, KC_NO,   KC_LALT, MO(_LW), KC_SPC,  KC_BSPC, KC_BSPC, MO(_FN), MO(_RS), KC_F2,   M(1)   , KC_LEFT, KC_DOWN, KC_RGHT  },
 },
 ...
 * |--------+--------+--------+--------+--------+- 2u ------------+--------+--------+--------+--------+-----------------+--------+--------|
 * |   LED  | Toggle |        |        |        | XXXXXX .        |        |        |        |        |        |DecBreat|        |IncrBrea|
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
 ...
 [_LW] = { /* LOWERED */
  ...
  { M(0)   , M(1) ,   M(2) ,   _______, _______, _______, _______, _______, _______, _______, _______, _______, M(3)   , _______, M(2)     },
 },

/* RAISED
 * .---------------------------------------------------------------------------------------------------------------------- 2u ------------.
 * |        | F1     | F2     | F3     | F4     | F5     | F6     | F7     | F8     | 7      | 8      | 9      | NumLock| XXXXXX .        |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------|
 * |        | F5     | F6     | F7     | F8     | 5      | 6      | 7      | 8      | 4      | 5      | 6      |        |        | INS    |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+- 2u ------------+--------|
 * |        | F9     | F10    | F11    | F12    | F5     | F6     | -      | =      | 1      | 2      | 3      | XXXXXX .        |        |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+- 2u ---------------------+--------|
 * |        | F13    | F14    | F15    | F16    | F11    | F12    |        |        | 0      | .      | XXXXXX .        |  VolU  |        |
 * |--------+--------+--------+--------+--------+- 2u ------------+--------+--------+--------+--------+-----------------+--------+--------|
 * |        |        |        |        |        | XXXXXX .        |        |        |        |        |Play/Pau|  Prev  |  VolD  |  Next  |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
 
 [_RS] = { /* RAISED */
  { _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_P7,   KC_P8,  KC_P9, KC_NLCK, ___T___, ___T___  },
  { _______, KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_5,    KC_6,    KC_7,    KC_8,    KC_P4,   KC_P5,  KC_P6, _______, _______, KC_INS   },
  { _______, KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_F5,   KC_F6,   KC_MINS, KC_EQL,  KC_P1,   KC_P2,  KC_P3, KC_PENT, ___T___, _______  },
  { _______, KC_F13,  KC_F14,  KC_F15,  KC_F16,  KC_F11,  KC_F12,  _______, _______, KC_P0,   KC_PDOT,___T___, ___T___, KC_VOLU, _______  },
  { _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,KC_MPLY, KC_MPRV, KC_VOLD, KC_MNXT  },
 },
...
const macro_t *action_get_macro(keyrecord_t *record, uint8_t id, uint8_t opt)
{
  // MACRODOWN only works in this function
      switch(id) {
        ...
        case 5:
          if(record->event.pressed) {
           // register_code(KC_LCTL, KC_BSPC);
          } else {
           // unregister_code(KC_LCTL, KC_BSPC);
          }
          break;
      }
    return MACRO_NONE;
